<?php
/**
 * Plugin Name:       The Events Calendar Extension: Multiple Venues Per Event
 * Plugin URI:        https://theeventscalendar.com/extensions/---the-extension-article-url---/
 * GitHub Plugin URI: https://github.com/mt-support/tribe-ext-multiple-venues-per-event
 * Description:       Add multiple Venues to a single Event, just like Organizers.
 * Version:           1.0.0
 * Extension Class:   Tribe\Extensions\Multi_Venue_Events\Main
 * Author:            Modern Tribe, Inc.
 * Author URI:        http://m.tri.be/1971
 * License:           GPL version 3 or any later version
 * License URI:       https://www.gnu.org/licenses/gpl-3.0.html
 * Text Domain:       tribe-ext-multiple-venues-per-event
 *
...
namespace Tribe\Extensions\Multi_Venue_Events;
...
if ( ! defined( NS . 'PLUGIN_TEXT_DOMAIN' ) ) {
	// `Tribe\Extensions\Multi_Venue_Events\PLUGIN_TEXT_DOMAIN` is defined
	define( NS . 'PLUGIN_TEXT_DOMAIN', 'tribe-ext-multiple-venues-per-event' );
}
...
if (
	...
	class Main extends Tribe__Extension {
		...
		public function init() {
			...
			// Don't forget to generate the 'languages/tribe-ext-multiple-venues-per-event.pot' file
